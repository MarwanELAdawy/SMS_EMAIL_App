...
public class SmsSender
{
    public static string Send(string phone, string message)
    {
        ...
        var myRequest = new MyWebRequest("http://tamayozsms.com/api/sendsms.php?", "POST", "username=ACIG&password=ACIG123456&numbers=" + phone +"&message=" + message + "&sender=ACIG&unicode=u&return=xml");
