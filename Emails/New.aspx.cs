...
public partial class Emails_New : System.Web.UI.Page
{
    ...
    protected void btnSend_Click(object sender, EventArgs e)
    {
        ...
        var email = new tbl_Emails_SMS { Claim_Number = claimNumber, Policy_Number = txtPolicyNumber.Text, TP_Name = txtTpName.Text, Email = txtEmail.Text, Text = txtText.Text, Type = "Email", User_Id = currentUserId, Created_At = DateTime.Now };
