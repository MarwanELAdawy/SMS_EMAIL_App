...
public partial class Emails_New : System.Web.UI.Page
{
    ...
    protected void btnSend_Click(object sender, EventArgs e)
    {
        ...
        var email = new tbl_Emails_SMS { Claim_Number = txtClaimNumber.Text, Policy_Number = txtPolicyNumber.Text, TP_Name = txtTpName.Text, Email = txtEmail.Text, Text = txtText.Text, Type = "Email", User_Id = currentUserId, Created_At = DateTime.Now, Mobile_Number = txtMobile.Text, Email_Subject = txtSubject.Text, TP_ID = txtTPID.Text };
